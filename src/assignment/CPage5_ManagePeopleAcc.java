 ...
 * @author Zhi Yan
 */
public class CPage5_ManagePeopleAcc extends javax.swing.JFrame {

    /**
     * Creates new form CPage5
     */
    public CPage5_ManagePeopleAcc() {
        initComponents();
    ...
    private void initComponents() {
        ...
        PeoAcc.setBackground(new java.awt.Color(0, 153, 153));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CPage5_ManagePeopleAcc.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CPage5_ManagePeopleAcc().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTable people_table;
