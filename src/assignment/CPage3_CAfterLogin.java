 ...
 * @author Zhi Yan
 */
public class CPage3_CAfterLogin extends javax.swing.JFrame {

    /**
     * Creates new form CPage3
     */
    public CPage3_CAfterLogin() {
        initComponents();
    ...
    private void PersonalInfoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_PersonalInfoActionPerformed
        // TODO add your handling code here:
        this.dispose();
        CPage4_CPersonalInfo PeopleInfo= new CPage4_CPersonalInfo();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CPage3_CAfterLogin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CPage3_CAfterLogin().setVisible(true);
            }
        });
    }
