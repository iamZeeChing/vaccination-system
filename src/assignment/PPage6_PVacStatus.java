 ...
 * @author ching
 */
public class PPage6_PVacStatus extends javax.swing.JFrame {

    /**
     * Creates new form PPage6
     */
    public PPage6_PVacStatus() {
        initComponents();
    ...
    private void RegVacActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_RegVacActionPerformed
        ...
        this.dispose();
        PPage5_PRegisterVac PeopleRegVac= new PPage5_PRegisterVac();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PPage6_PVacStatus.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PPage6_PVacStatus().setVisible(true);
            }
        });
    }
