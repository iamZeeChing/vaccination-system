 ...
 * @author ching
 */
public class PPage3_PAfterLogin extends javax.swing.JFrame {

    /**
     * Creates new form PPage3
     */
    public PPage3_PAfterLogin() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PPage3_PAfterLogin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PPage3_PAfterLogin().setVisible(true);
            }
        });
    }
