 ...
 * @author Zhi Yan
 */
public class CPage4_CPersonalInfo extends javax.swing.JFrame {

    /**
     * Creates new form CPage4
     */
    public CPage4_CPersonalInfo() {
        initComponents();
    ...
    private void PeoAccActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_PeoAccActionPerformed
        ...
        this.dispose();
        CPage5_ManagePeopleAcc PeoAcc= new CPage5_ManagePeopleAcc();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CPage4_CPersonalInfo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CPage4_CPersonalInfo().setVisible(true);
            }
        });
    }
