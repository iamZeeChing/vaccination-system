 ...
 * @author ching
 */
public class PPage1_PRegister extends javax.swing.JFrame {

    /**
     * Creates new form PPage1
     */
    public PPage1_PRegister() {
        initComponents();
    ...
    private void PReturnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_PReturnActionPerformed
        this.dispose();
        Page3_People committeePage= new Page3_People();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PPage1_PRegister.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PPage1_PRegister().setVisible(true);
            }
        });
    }
