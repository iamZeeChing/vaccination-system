 ...
 * @author ching
 */
public class PPage5_PRegisterVac extends javax.swing.JFrame {

    /**
     * Creates new form PPage5
     */
    public PPage5_PRegisterVac() {
        initComponents();
    ...
    private void initComponents() {
        ...
        VacStatus3 = new javax.swing.JButton();
        VacStatus4 = new javax.swing.JButton();
        ...
        VacStatus3.setBackground(new java.awt.Color(255, 0, 0));
        VacStatus3.setFont(new java.awt.Font("Segoe UI Black", 1, 14)); // NOI18N
        VacStatus3.setForeground(new java.awt.Color(255, 255, 255));
        VacStatus3.setText("LOGOUT");
        VacStatus3.setToolTipText("");
        VacStatus3.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                VacStatus3ActionPerformed(evt);
            }
        });

        VacStatus4.setBackground(new java.awt.Color(255, 0, 0));
        VacStatus4.setFont(new java.awt.Font("Segoe UI Black", 1, 14)); // NOI18N
        VacStatus4.setForeground(new java.awt.Color(255, 255, 255));
        VacStatus4.setText("LOGOUT");
        VacStatus4.setToolTipText("");
        VacStatus4.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                VacStatus4ActionPerformed(evt);
            }
        });
        ...
        RegVac.setBackground(new java.awt.Color(0, 153, 153));
    ...
    private void PersonalInfoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_PersonalInfoActionPerformed
        // TODO add your handling code here:
        this.dispose();
        PPage4_PPersonalInfo PeopleInfo= new PPage4_PPersonalInfo();
    ...
    private void VacStatusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_VacStatusActionPerformed
        // TODO add your handling code here:
        this.dispose();
        PPage6_PVacStatus PeopleVacStatus= new PPage6_PVacStatus();
        PeopleVacStatus.setVisible(true);

    }//GEN-LAST:event_VacStatusActionPerformed

    private void VacStatus3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_VacStatus3ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_VacStatus3ActionPerformed

    private void VacStatus4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_VacStatus4ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_VacStatus4ActionPerformed

    private void logoutActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_logoutActionPerformed
        // TODO add your handling code here:
        this.dispose();
        Page3_People peopage1= new Page3_People();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PPage5_PRegisterVac.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PPage5_PRegisterVac().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JButton VacStatus3;
    private javax.swing.JButton VacStatus4;
