 ...
 * @author Zhi Yan
 */
public class CPage7_SupplyVac extends javax.swing.JFrame {

    /**
     * Creates new form CPage7
     */
    public CPage7_SupplyVac() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CPage7_SupplyVac.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CPage7_SupplyVac().setVisible(true);
            }
        });
    }
