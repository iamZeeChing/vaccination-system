 ...
 * @author Zhi Yan
 */
public class CPage8_Report extends javax.swing.JFrame {

    /**
     * Creates new form CPage8
     */
    public CPage8_Report() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        StatRe.setBackground(new java.awt.Color(0, 153, 153));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CPage8_Report.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CPage8_Report().setVisible(true);
            }
        });
    }
