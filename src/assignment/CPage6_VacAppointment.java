 ...
 * @author Zhi Yan
 */
public class CPage6_VacAppointment extends javax.swing.JFrame {

    /**
     * Creates new form CPage6
     */
    public CPage6_VacAppointment() {
        initComponents();
    ...
    private void initComponents() {
        ...
        VacAppoint.setBackground(new java.awt.Color(0, 153, 153));
    ...
    private void PersonalInfoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_PersonalInfoActionPerformed
        // TODO add your handling code here:
        this.dispose();
        CPage4_CPersonalInfo PersonalInfo= new CPage4_CPersonalInfo();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CPage6_VacAppointment.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CPage6_VacAppointment().setVisible(true);
            }
        });
    }
